...
class MyUserAdmin(UserAdmin):
    fieldsets = (
        ...
        (_('Personal info'), {'fields': ('first_name', 'last_name', 'email', 'username', 'birthday','gender','unvani','phone','study','subjects','profile_picture', 'branch', 'branch_status','position','usertype')}),
...
class AttendenseAdmin(admin.ModelAdmin):
    ...
    list_filter = ('day',('status',custom_titled_filter("Davamiyyətin statusuna ")),('teach__first_name',custom_titled_filter("Müəllimin adına ")),('people__full_name',custom_titled_filter("Tələbənin adına ")))
...
admin.site.register(PandaBranch)
